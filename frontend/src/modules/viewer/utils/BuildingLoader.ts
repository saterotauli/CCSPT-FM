...
import { createBuildingMarker, createSpaceMarker, ensureGlobalMarkerCSS } from "./Markers";
 ...
 * Mirrors the behavior used in `ui/sections/models.ts` dropdown handler.
 */
...
export async function loadBuilding(components: OBC.Components, buildingCode: string, options: LoadOptions = {}) {
  ...
  try {
    ...
    const buildingFilesRooms: Record<string, string[]> = {
      'MAP': ['Rooms/CCSPT-MAP-M3D-Rooms.frag'],
      'SAL': ['Rooms/CCSPT-SAL-M3D-Rooms.frag'],
      'TAU': ['Rooms/CCSPT-TAU-M3D-Rooms.frag'],
      'TOC': ['Rooms/CCSPT-TOC-M3D-Rooms.frag'],
      'ALB': ['Rooms/CCSPT-ALB-M3D-Rooms.frag'],
      'CQA': ['Rooms/CCSPT-CQA-M3D-Rooms.frag'],
      'MIN': ['Rooms/CCSPT-MIN-M3D-Rooms.frag'],
      'UDI': ['Rooms/CCSPT-UDI-M3D-Rooms.frag'],
      'VII': ['Rooms/CCSPT-VII-M3D-Rooms.frag'],
    };
