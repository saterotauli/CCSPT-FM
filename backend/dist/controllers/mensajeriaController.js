...
exports.marcarTodasNotificacionesLeidas = exports.marcarNotificacionLeida = exports.getNotificaciones = exports.enviarMensaje = exports.createConversacion = exports.getConversacion = exports.getConversaciones = void 0;
...
exports.createConversacion = createConversacion;
    ...
    try {
        ...
        const notificacionesPromises = otrosParticipantes.map(async (participante) => {
            await Promise.all([
                ...
                firebaseService_1.FirebaseService.sendNotificationToUser(participante.usuarioId, {
...
exports.marcarTodasNotificacionesLeidas = marcarTodasNotificacionesLeidas;
